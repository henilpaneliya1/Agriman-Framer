					...
					$rs1 = mysqli_fetch_array($qsql1);
				 	echo "
						...
						<td>&nbsp;<img src='imgsellingproduct/$rs1[product_img1]' width='75' height='75'></td>
						  ...
						  <td>&nbsp;" . $config['CURRENCY_SYMBOL'] . $rs['cost'] . "</td>
						  <td>&nbsp;$rs[quantity]</td>
						  <td>&nbsp;<span id='calccost$i'>" . $config['CURRENCY_SYMBOL'] . ($rs['cost'] * $rs['quantity']) . "</span></td>					  
						</tr>";
						$i++;
...
?>
    ...
    <tr>
      ...
      <th>&nbsp;<?php echo $config['CURRENCY_SYMBOL']; ?>  <?php echo $tot; ?></th>
    </tr>								
								</tfoot>
						  </table>
...
<div class="form-row">
	...
	<div class="col-md-6 form-group">
		State<font color="#FF0000">*</font>
	  	<span id='loadstate'>
		<select name="cststate" id="cststate" onChange="loadcity(this.value)" class="form-control">
