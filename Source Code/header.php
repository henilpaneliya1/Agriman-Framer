...
<head>
  ...
  <title><?php echo $config['PROJECT_TITLE']; ?> - <?php echo $config['PROJECT_TAGLINE']; ?></title>

  <meta content="Agriculture Management System" name="keywords">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center">
        <div class="logo mr-auto">
          <h1 class="text-light"><a href="index.php"><span><?php echo  strtoupper($config['PROJECT_TITLE']); ?></span></a></h1>
